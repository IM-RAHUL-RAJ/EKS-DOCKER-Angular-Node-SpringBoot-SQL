...
class TradeMyBatisImplTest {
	...
	public void testInsertTrade() {
		Trade newTrade = new Trade("T007", "C005", "O005", "I005", 50, BigDecimal.valueOf(145.00), "B",
	...
	public void testInsertOrder() {
		...
		Order newOrder = new Order("O006", "C005", "I005", 11, BigDecimal.valueOf(145.00), "B", OrderStatus.EXECUTED,
				Timestamp.valueOf("2023-01-01 20:00:00"));
	...
	void testModifyOrder() {
		Order modifyOrder = new Order("O001", "C001", "I001", 20, new BigDecimal(245.00).setScale(2), "B",
				OrderStatus.CANCELED, Timestamp.valueOf("2023-01-02 21:00:00"));
	...
	void testExecuteOrder() {
		Trade trade = tradeDao.executeOrder(new Order("O002", "C001", "I001", 1, new BigDecimal(1), "S",
				OrderStatus.EXECUTED, Timestamp.valueOf("2023-01-01 20:00:00")));
		assertNotNull(trade);
	}
	...
	@Test
	void testGetClientTradingHistoryToThrowIllegalArgumentException() {
		assertThrows(IllegalArgumentException.class, ()->{
			tradeDao.getClientTradeHistory(null);
		});
	}
