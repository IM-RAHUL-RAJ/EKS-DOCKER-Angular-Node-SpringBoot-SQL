...
describe('BuyFormComponent', () => {
  ...
  it('should alert "Not Enough Cash! Get a Job" when verifyTradeCost is called with insufficient cash', () => {
    ...
    component.verifyTradeCost();
    expect(window.alert).toHaveBeenCalledWith('Not Enough Cash! Get a Job');
  });
